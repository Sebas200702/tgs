  ...
  return (
    <div data-testid="canchas-page" className="min-h-screen">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <h2 className="font-display text-4xl md:text-5xl font-black text-[#1F4D2A] text-center mb-10">
          Canchas Disponibles
        </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-7">
            ...
            >
              <img
                src={
                  c.imagenes?.[0] ||
                  c.local?.imagen ||
                  "https://images.unsplash.com/photo-1647118868186-70d38e10b0dc?w=800"
                }
                alt={c.nombre}
              ...
              <div className="p-5">
                ...
                <p className="text-xs text-[#4B5563] mt-1 flex items-start gap-1">
                  <MapPin size={12} className="mt-0.5 flex-shrink-0" />{" "}
                  {c.local?.direccion}
                </p>
                <div className="flex items-center justify-between mt-4">
                  <span className="font-display font-bold text-[#1F4D2A]">
                    {formatCOP(c.precio_base, false)}
          ...
          {filtered.length === 0 && (
            <div
              className="col-span-full text-center text-[#4B5563] py-10"
              data-testid="no-canchas"
            >
